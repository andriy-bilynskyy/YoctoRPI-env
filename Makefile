...
ifeq ($(origin BB_ARGS),undefined)
	...
	@(source ./poky/oe-init-build-env $(BUILD_DIR) && bitbake $(BB_VERBOSE) $(BB_ARGS))
endif
...
ifeq ($(origin BB_ARGS),undefined)
	...
	@(source ./poky/oe-init-build-env $(BUILD_DIR) && bitbake-layers $(BB_VERBOSE) $(BB_ARGS))
endif
